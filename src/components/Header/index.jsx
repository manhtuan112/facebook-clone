  ...
  return (
    <div className="header">
      ...
      <div className="header__right">
        ...
        <IconButton color="inherit" sx={{backgroundColor:'#e4e6eb', margin: '0px 5px'}}>
          <CgMenuGridO fontSize="26px"/>
        </IconButton>
        <IconButton color="inherit" sx={{backgroundColor:'#e4e6eb', margin: '0px 5px'}}>
          <FaFacebookMessenger fontSize="26px" />
        </IconButton>
        <IconButton color="inherit" sx={{backgroundColor:'#e4e6eb', margin: '0px 5px'}}>
          <IoMdNotifications fontSize="26px" />
        </IconButton>
        <IconButton color="inherit" sx={{backgroundColor:'#e4e6eb', margin: '0px 5px'}}>
          <IoMdArrowDropdown fontSize="26px" />
        </IconButton>
      </div>
    </div>
  );
